  ...
  function patch(){
    ...
    try{
      ...
      if(tag && !hero.querySelector(`[data-soe=mm-cat]`)){
        /* owner 07-20: category text sits to the RIGHT of the logo, and the pair hugs the headline */
        var row=document.createElement(`div`); row.setAttribute(`data-soe`,`mm-cat-row`);
      ...
      var wrapWhy=document.createElement(`div`); wrapWhy.innerHTML=`<section id="mt-why" data-soe="why"><div data-soe="why-inner"><div data-soe="why-head"><span data-soe="eyebrow">Why speed it up</span><h2 data-soe="bm-h2">Why Speeding Up Material Handling Is Smart</h2><p data-soe="why-lede">For a landscape contractor, moving material by the cubic yard is one of the biggest labor costs on the job — and the slowest, most back-breaking part of the day. Every hour spent shoveling, hand-loading wheelbarrows, and babysitting a rusting steel bed is an hour not spent on billable work. Built from more than 30 years of in-the-field experience, the Mulch Mule takes that bottleneck off your crew and turns it into profit. Here’s what the Mulch Mule solves:</p></div><div data-soe="why-grid"><div data-soe="why-item"><strong>Unloading and spreading mulch eats the whole day.</strong> Shoveling and hand-spreading material by the cubic yard is the slowest, most expensive part of the job.</div><div data-soe="why-item"><strong>The heavy lifting burns crews out.</strong> The most physical work on the job drives fatigue, injuries, and the turnover that’s so hard to recover from.</div><div data-soe="why-item"><strong>Slow material handling caps how many jobs you run.</strong> When loading and unloading drags, crew capacity — and revenue per day — hits a ceiling.</div><div data-soe="why-item"><strong>Someone’s always stuck hand-loading wheelbarrows.</strong> A worker tied to filling wheelbarrows is a worker who isn’t planting, spreading, or billing.</div><div data-soe="why-item"><strong>Labor costs keep climbing.</strong> Manual material handling is where the hours, and the dollars, quietly pile up.</div><div data-soe="why-item"><strong>Steel beds rust out and lose their value.</strong> The mulch, soil, and salt that pay the bills are the same materials that corrode a steel trailer and tank its resale.</div></div></div></section>`;
...
(function(){
  ...
  var equipMenu = [
    {brand:`Mulch Trailer`, href:`/mulch-trailers/mulch-mule`, items:[
      [`Mulch Mule`,`/mulch-trailers/mulch-mule`]
    ]},
    ...
    {brand:`Brine Equipment`, href:`/camion`, items:[
      ...
      [`Brine Sprayers`,`/brine-sprayers/ice-master-t-series`],
      [`Brine Storage Tanks`,`/brine-storage-tanks/camion-brine-storage-tank`],
      [`Diesel Transfer Tanks`,`/diesel-transfer-tanks/camion-diesel-fuel-boss`]
    ]}
  ];
...
(function(){
  ...
  function wireHomeWatch(){
    if(path!==`/`)return;
    var MAP={ "mulch mule":`X8TkDU5Vllo`, "energreen":`yHaA7LCPtWY`, "camion":`hjw80ZkfVPQ` };
    ...
    Array.prototype.forEach.call(document.querySelectorAll(`[data-soe=hero-ctas]`),function(ctas){
      ...
      if(!secondary)return;
      var vid=MAP[brand];
      if(vid){ secondary.textContent=`Watch Video`; secondary.setAttribute(`data-soe-video`,vid); secondary.setAttribute(`href`,`#`); secondary.removeAttribute(`data-soe-disabled`); secondary.removeAttribute(`aria-disabled`); }
      else { /* owner 07-20: keep the slot — every brand shows two buttons */
        secondary.textContent=`Video Coming Soon`; secondary.setAttribute(`href`,`#`);
        secondary.setAttribute(`data-soe-disabled`,``); secondary.setAttribute(`aria-disabled`,`true`); secondary.setAttribute(`tabindex`,`-1`);
        secondary.removeAttribute(`data-soe-video`);
      }
    });
  }
